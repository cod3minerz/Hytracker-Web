      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Условия использования", "Политика конфиденциальности", "Cookie"].map((link) => (
                <li key={link}>
                  <a href="#" className="text-[0.8125rem] text-muted-foreground hover:text-primary transition-colors">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {/* Discord */}
              <a href="#" className="w-9 h-9 rounded-lg bg-secondary flex items-center justify-center hover:bg-primary hover:text-white text-muted-foreground transition-colors">
